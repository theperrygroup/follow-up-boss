...
def test_add_attachment_to_deal_file_not_implemented(deal_attachments_api, test_deal_id):
...
def test_update_deal_attachment(deal_attachments_api, test_attachment_id):
    ...
    updated_description = f"Updated description {datetime.now().strftime('%Y%m%d%H%M%S')}"
...
def test_delete_deal_attachment(deal_attachments_api, test_deal_id):
    ...
    try:
        ...
        attachment_id = test_add_attachment_to_deal_uri(deal_attachments_api, test_deal_id)
